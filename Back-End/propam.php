...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="Pictures/books/pamela.jpg" alt="Book preview" width="75%" id="mainimages">
            <!--
        ...
        <div class="single-pro-details">
            ...
            <h6><strong>Love,Pamela: A Memoir of Prose, Poetry, and Truth</strong></h6>
            <h2>$100</h2>
            <button class="normal">Message the Seller</button>
            <h4>Product Details</h4>
            <span>The actress, activist, and once infamous Playboy 
            Playmate reclaims the narrative of her life in a memoir that 
            defies expectation in both content and approach, blending searing prose with snippets of original poetry.</span>
        </div>
    </section>
    ...
    <section id="product1">
        <div class="container my-5">
          ...
          <div class="row">
            <div class="col-md-4">
              <div class="card">
                <img src="Pictures/books/Harry.jpg" height="350" alt="Book preview">
                <div class="card-body">
                  <h5 class="card-title">Prince Harry Spare</h5>
                  <p class="card-text">It was one of the...</p>
                  <h4>$135</h4>
