...
<head>
  ...
  <title>University Textbook Market Place</title>
</head>
...
<body>
  ...
  <!--Hero section.-->
    <section id="hero">
      <h4 style="color:black">U of R Buy & Sell</h4>
      <h2 style="color:black">Made By the Students</h2>
      <h1 style="color: black">For The Students</h1>
      <p style="color:black">Shop Responsible</p>
      <button class="normal" onclick="window.location.href='books.html';">shop Now</button>
    </section>

  <!-- Featured books -->
  <section id="product1">
  <div class="container my-5">
    <h1 class="text-center">Featured Textbooks</h1>
    <hr>
    <div class="row">
    ...
    <div class="colum">
      ...
      <h4><strong>Contact</strong></h4>
        ...
        <div class="colum">
          ...
          <!--<a href="http://www.webdev.cs.uregina.ca/~jls273/cs476/login.html"> Login</a>-->
          <a href="login.php"> Login</a>
          <!--<a href="http://www.webdev.cs.uregina.ca/~jls273/cs476/signup.html"> Sign-up</a> -->
