...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="Pictures/books/overthinking1.jpg" alt="Book preview" width="75%" id="mainimages">
            <!--
        ...
        <h6><strong>Books</strong></h6>
            <h6><strong>Stop Overthinking: 23 Techniques to Relieve Stress, Stop Negative Spirals, Declutter Your Mind, and Focus on the Present </strong></h6>
            <h2>$137</h2>
            <button class="normal">Message the Seller</button>
            <h4>Product Details</h4>
            <span>IOvercome negative thought patterns, reduce stress, and live a worry-free life.
                Overthinking is the biggest cause of unhappiness. Don't get stuck in a never-ending thought loop. Stay present and keep your mind off things that don't matter, and never will.</span>
        </div>
    </section>
