...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="Pictures/books/mat.jpg" alt="Book preview" width="75%" id="mainimages">
            <!--
        ...
        <h6><strong>Books</strong></h6>
            <h6><strong>Friends, Lovers, and the Big Terrible Thing: A Memoir</strong></h6>
            <h2>$110</h2>
            <button class="normal">Message the Seller</button>
            <h4>Product Details</h4>
            <span>The BELOVED STAR OF FRIENDS takes us behind the scenes of the hit sitcom and his 
            struggles with addiction in this “CANDID, DARKLY FUNNY...POIGNANT” memoir (The New York Times).
            A MOST ANTICIPATED BOOK by Time, Associated Press, Goodreads, USA Today, and more!</span>
        </div>
    </section>
