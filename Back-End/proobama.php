...
<body>
    ...
    <section id="prodetails" class="section-p1">
        <div class="single-pro-image">
            <img src="Pictures/books/obama.jpg" alt="Book preview" width="75%" id="mainimages">
        </div>

        <!--Prodct explanation-->
        <div class="single-pro-details">
        <h6><strong>Books</strong></h6>
            <h6><strong>The Light We Carry: Overcoming in Uncertain Times</strong></h6>
            <h2>$137</h2>
            <button class="normal">Message the Seller</button>
            <h4>Product Details</h4>
            <span>#1 NEW YORK TIMES AND USA TODAY BESTSELLER • ONE OF TIMES 100 MUST-READ BOOKS OF 2022 • In an inspiring follow-up to her 
                critically acclaimed, #1 bestselling memoir Becoming, former First Lady Michelle Obama shares practical wisdom and powerful 
                strategies for staying hopeful and balanced in todays highly uncertain world.</span>
        </div>
    </section>
    ...
    <section id="product1">
        <div class="container my-5">
          ...
          <div class="row">
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="Pictures/books/overthinking1.jpg" height="350" alt="Book preview">
                <div class="card-body">
                  <h5 class="card-title">Stop Overthinking</h5>
                  <p class="card-text">A step-by-step guide ...</p>
                  <h4>$150</h4>
                  <a href="#" class="btn btn-primary" onclick="window.location.href='prooverthink.php';">Learn More</a>
                  <div class="d-flex justify-content-between">
                    <div class="seller-info">
                      <img src="https://i.pravatar.cc/150?img=1" alt="Seller Profile Picture" class="seller-img">
                      <p class="seller-name">John Doe</p>
            ...
            <div class="col-md-4">
              <div class="card">
                <img src="Pictures/books/Harry.jpg" height="350" alt="...">
                <div class="card-body">
                  <h5 class="card-title">Prince Harry Spare</h5>
                  <p class="card-text">Prince harry decided ...</p>
                  <h4>$135</h4>
                  <a href="#" class="btn btn-primary" onclick="window.location.href='proharry.php';">Learn More</a>
                  <div class="d-flex justify-content-between">
                    <div class="seller-info">
                      <img src="https://i.pravatar.cc/150?img=1" alt="Seller Profile Picture" class="seller-img">
                      <p class="seller-name">John Doe</p>
